...
from textual.widgets import FileClick, ScrollView, Placeholder

from sherlock.ui.sherlock_widgets import SherlockHeader, SherlockFooter, LogListView
...
class MyApp(App):
    ...
    async def on_mount(self) -> None:
        ...
        self.directory = LogListView()

        # Dock our widgets
        await self.view.dock(SherlockHeader(), edge="top")
        await self.view.dock(SherlockFooter(), edge="bottom")
